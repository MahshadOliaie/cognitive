...
function PublisherPage() {
    ...
    const publishers = useFetch(`https://cogcenter.ir/library/api/v1/publishers?page=${currentPage}&size=10`)
    ...
    useEffect(() => {
        fetch(`https://cogcenter.ir/library/api/v1/publishers?page=${currentPage}&size=10`, {
            headers: {
                'accept': '*/*',
