...
function AuthorPage() {
    ...
    const authors = useFetch(`https://cogcenter.ir/library/api/v1/authors?page=${currentPage}&size=10`)
    ...
    useEffect(() => {
        fetch(`https://cogcenter.ir/library/api/v1/authors?page=${currentPage}&size=10`, {
            headers: {
                'accept': '*/*',
    ...
    return (
        <>
            ...
            <Pagination pages={authors.totalPages} currentPage={currentPage} setCurrentPage={setCurrentPage} />
        </>
    )
}
