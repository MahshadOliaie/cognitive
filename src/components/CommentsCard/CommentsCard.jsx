...
function CommentsCard({ comment, onClick}) {
    ...
    const { id, userName, text, userImage, modelType, reaction, publishAt, updateAt, publish } = comment
    ...
    return (
        <div className="bg-sand shadow-md flex items-center justify-between gap-8 border-r-4 rounded-xl w-full p-8 py-5 relative" style={{ borderColor: pastel }}>
            ...
            <div className="flex-shrink-0 flex flex-col gap-3">
                ...
                <p className="opacity-60"><span className="font-medium">آخرین آپدیت: </span>{new Date(updateAt).toLocaleDateString()}</p>
            </div>
            ...
            <div className="flex gap-4 flex-col">
                ...
                <p className="flex items-center gap-2 text-sm">
                    ...
                    {reaction.DISLIKE.count}</p>
            </div>

            <div className="flex flex-col gap-3">
                <DeleteBtn bgColor={pastel} />
