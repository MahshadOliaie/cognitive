...
function SearchBar({ columnFilters, setColumnFilters , title }) {
    ...
    return (
        <div className="relative">
            ...
            <input type="search" value={valueTitle} onChange={(e) => handleChange(title, e.target.value)} placeholder="جستجو" className="bg-sand px-8 py-3 pr-14 rounded-full w-80 focus-visible:outline-sandals" />
        </div>
    )
}
