...
function PublisherModal({ setIsModalOpen, modalData, setEditModal }) {
    ...
    setValue("publisherEnable", enable)
                ...
                <div className="shadow-md rounded-lg p-10 pt-0 bg-linen" >
                    ...
                    <form className="flex flex-col gap-6 py-5 pb-7" style={{ minWidth: "450px" }}>
                        ...
                        <div className="flex flex-col flex-1">
                            ...
                            {errors.publisherName && <p style={{ color: "red", fontSize: "12px" }}>{errors.publisherName.message}</p>}
                        </div>

                        <div className="flex items-center gap-2">
                            <EnableCheckbox enable={enable} setEnable={setEnable} {...register("publisherEnable")} />
