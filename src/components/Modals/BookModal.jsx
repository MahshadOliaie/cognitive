            ...
            <div className="shadow-md rounded-lg p-10 pt-0 bg-linen" >
                ...
                <form className="flex flex-col gap-6" style={{ minWidth: "450px" }}>
                    ...
                    <div className="flex flex-col flex-1">
                        ...
                        <input className="p-2 rounded-md shadow-inner focus-visible:border-2 border-dark outline-none" type="number" name="translator" id="translator" defaultValue={(modalData.id) && modalData.original.translators}
